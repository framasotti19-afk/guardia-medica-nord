...
Test dedicati: `test_max_turni_mese.mjs` (7 casi), `test_distribuzione_temporale.mjs` (8 casi, inclusi un caso dedicato alla priorità di sede assoluta sull'equidistanza e uno dedicato alla selezione cross-livello), `test_aggiustamento_mensile.mjs` (16 casi: tetto DET38 14/13, DET24 8/9, DET12/DET12ASAP 5/4 nei mesi giusti e sbagliati, INDET invariato, totali annui 165/104/52). Invarianti aggiuntivi nella simulazione massiva (§8, §12): tetto mensile mai superato (INV-MAXTURNI), titolarità sempre rispettata (con il limite noto residuo di cui sopra, §3.1a).
