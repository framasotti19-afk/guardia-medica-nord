...
node test_distribuzione_temporale.mjs  # 9 test distribuzione run-then-redistribute, priorità di sede, cross-livello, titolari non esenti, pool su tutto il mese con cap esplicito (§3.11)
...
```bash
node test_email_generator.mjs                  # genera test_email_corpus.json (1450 casi)
